...
% optimization variables (17 for {'ikto', 'ikslow1', 'ikslow2', 'ikss'})
p1 = optimizableVariable('p1', [lb(1), ub(1)]);
p2 = optimizableVariable('p2', [lb(2), ub(2)]);
p3 = optimizableVariable('p3', [lb(3), ub(3)]);
p4 = optimizableVariable('p4', [lb(4), ub(4)]);
p5 = optimizableVariable('p5', [lb(5), ub(5)]);
p6 = optimizableVariable('p6', [lb(6), ub(6)]);
p7 = optimizableVariable('p7', [lb(7), ub(7)]);
p8 = optimizableVariable('p8', [lb(8), ub(8)]);
p9 = optimizableVariable('p9', [lb(9), ub(9)]);
p10 = optimizableVariable('p10', [lb(10), ub(10)]);
p11 = optimizableVariable('p11', [lb(11), ub(11)]);
p12 = optimizableVariable('p12', [lb(12), ub(12)]);
p13 = optimizableVariable('p13', [lb(13), ub(13)]);
p14 = optimizableVariable('p14', [lb(14), ub(14)]);
p15 = optimizableVariable('p15', [lb(15), ub(15)]);
p16 = optimizableVariable('p16', [lb(16), ub(16)]);
